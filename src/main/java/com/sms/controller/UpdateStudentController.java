...
public class UpdateStudentController {
    ...
    private boolean validateInput() {
        if (nameField.getText().isEmpty() || courseField.getText().isEmpty() || genderCombo.getValue() == null) {
            AlertUtil.showError("Validation Error", "Please fill in all required fields (Name, Course, Gender).");
            return false;
        }
